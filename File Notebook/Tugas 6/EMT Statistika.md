...
Prodi : Pendidikan Matematika A 2022
...
![images/fix-001.png](images/fix-001.png)

Kita menghitung probabilitas atau kemungkinan suatu nilai lebih besar
dari 1005, dengan asumsi nilai terukur berdistribusi normal.
...
Ini adalah plot distribusinya.


\>plot2d(r,v,a=150,b=200,c=0,d=190,bar=1,style="\\/"):


![images/fix-003.png](images/fix-003.png)
...
Rumus distribusi normal dengan rata-rata m dan simpangan baku d
adalah:


$$y=\frac{1}{d\sqrt{2\pi}}e^{\frac{-(x-m)^2}{2d^2}}.$$Karena nilainya antara 0 dan 1, maka untuk memplotnya pada diagram
batang harus dikalikan dengan 4 kali jumlah data.
...
![images/fix-005.png](images/fix-005.png)
...
tabel dari file. Pertama, kita menggunakan terjemahan kami sendiri
untuk tokennya.
...
Kita dapat cetak hasilnya di tabel baru.
...
![images/fix-006.png](images/fix-006.png)
...
![images/fix-007.png](images/fix-007.png)
...
![images/fix-008.png](images/fix-008.png)
...
![images/fix-011.png](images/fix-011.png)
...
![images/fix-012.png](images/fix-012.png)
...
![images/fix-013.png](images/fix-013.png)
...
![images/fix-016.png](images/fix-016.png)
...
![images/fix-017.png](images/fix-017.png)
...
Di Bridge(dek kartu), kami mengasumsikan 5 kartu beredar (dari 52) di
...
![images/fix-019.png](images/fix-019.png)
...
![images/fix-020.png](images/fix-020.png)
...
![images/fix-021.png](images/fix-021.png)
...
![images/fix-022.png](images/fix-022.png)
...
![images/fix-023.png](images/fix-023.png)
...
![images/fix-024.png](images/fix-024.png)
...
![images/fix-025.png](images/fix-025.png)
...
![images/fix-026.png](images/fix-026.png)
...
![images/fix-027.png](images/fix-027.png)
...
![images/fix-028.png](images/fix-028.png)
...
![images/fix-029.png](images/fix-029.png)
...
![images/fix-030.png](images/fix-030.png)
...
![images/fix-031.png](images/fix-031.png)
...
![images/fix-032.png](images/fix-032.png)
...
![images/fix-033.png](images/fix-033.png)
...
![images/fix-034.png](images/fix-034.png)
...
![images/fix-035.png](images/fix-035.png)
...
![images/fix-036.png](images/fix-036.png)
...
![images/fix-037.png](images/fix-037.png)
...
![images/fix-038.png](images/fix-038.png)
...
Kita bisa mem-plot ini sekarang.


\>columnsplot(fs,lab=3:18):


![images/fix-040.png](images/fix-040.png)
...
![images/fix-041.png](images/fix-041.png)
...
![images/fix-042.png](images/fix-042.png)
...
![images/fix-043.png](images/fix-043.png)
...
![images/fix-044.png](images/fix-044.png)

\>t=count(R,21);


Lalu kita bandingkan nilai harapannya.
...
![images/fix-045.png](images/fix-045.png)
...
![images/fix-046.png](images/fix-046.png)
...
![images/fix-047.png](images/fix-047.png)
...
![images/fix-048.png](images/fix-048.png)
...
![images/fix-049.png](images/fix-049.png)
...
Buatlah tabel data penjualan laptop dan grafik kenaikan dan penurunan
berdasarkan jumlah penjualan unit laptop Tahun 2017-2019 dari data
berikut :
...
Xiaomi : [5000,4500,4700]


Samsung :[4700,4800,4900]


HP : [5100,4900,5200]


Lenovo : [5500,5400,5300]


\>BW := [ ...  
\>   2017,7000,5000,4700,5100,5500; ...  
\>   2018,5500,4500,4800,5200,5400; ...  
\>   2019,4600,4700,4900,5200,5300]; 

\>P:=["MSI","Xiaomi","Samsung","HP","Lenovo"];
...
\>writetable(BT,wc=6,dc=0,\>fixed,labc=P,labr=YT)
             ...
             MSI Xiaomi Samsung    HP Lenovo
      2017  7000   5000    4700  5100   5500
      2018  5500   4500    4800  5200   5400
      2019  4600   4700    4900  5200   5300

tabel data penjualan hp
...
![images/fix-050.png](images/fix-050.png)

Grafik kenaikan dan penurunan berdasarkan jumlah penjualan unit HP
Tahun 2017-2019
