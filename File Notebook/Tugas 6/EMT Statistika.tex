...
\end{eulerprompt}
\eulerimg{16}{images/fix-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-003.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Karena nilainya antara 0 dan 1, maka untuk memplotnya pada diagram
...
\end{eulerprompt}
\eulerimg{16}{images/fix-005.png}
\eulerheading{Tabel}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-013.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{16}{images/fix-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-017.png}
\begin{eulercomment}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{16}{images/fix-019.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/fix-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-021.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{16}{images/fix-022.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{16}{images/fix-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-030.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/fix-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-034.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/fix-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-042.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/fix-043.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-044.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-045.png}
\begin{eulercomment}
Bersihkan data.
\end{eulercomment}
\begin{eulerprompt}
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{16}{images/fix-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-048.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/fix-049.png}
\begin{eulercomment}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{16}{images/fix-050.png}
\begin{eulercomment}
